...
public class VaccinationManagerController {
    ...
    /**
     * Lấy danh sách vs phân trang sự kiện tiêm chủng định kỳ
     */
    ...
    /**
     * Lấy danh sách phân trang và tìm kiếm sự kiện tiêm chủng định kỳ
     */
    ...
    /**
     * Lấy sự kiện tiêm chủng định kỳ ở id=?
     */
    ...
    /**
     * Tạo mới sự kiện tiêm chủng định kỳ
     */
    ...
    /**
     * Cập nhập thông tin sự kiện tiêm chủng định kỳ
     */
    ...
    public ResponseEntity<Vaccination> updateVaccination(@PathVariable("id") Integer id, @RequestBody VaccinationManagerDto vaccinationManagerDto) {
        ...
        vaccinationManagerDto.setLocationId(currentVaccination.getLocation().getLocationId());
    ...
    /**
     * Chỉnh sửa đã thực hiện công việc tiêm chủng định kỳ hoàn thành hay chưa.
     */
    ...
    /**
     * Xóa sự kiện tiêm chủng định kỳ
     */
