...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public void createNewEmployee(EmployeeDto employeeDto) throws MessagingException {
        ...
        Integer id = accountService.findIdUserByUserName(employeeDto.getIdCard());
        roleService.setDefaultRole(id, employeeDto.getAccount());
        employeeRepository.createNewEmployee(employeeDto.getName(), employeeDto.getDateOfBirth(), employeeDto.getIdCard(), employeeDto.getAddress(), employeeDto.getPhone(), employeeDto.getPosition(), id, false);
    }
